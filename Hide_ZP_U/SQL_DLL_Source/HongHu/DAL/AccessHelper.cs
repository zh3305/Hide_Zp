...
namespace HongHu.DAL.Using
{
    public class AccessHelper
    {
        ...
        #region ExecuteNonQuery 给定连接的数据库用假设参数执行一个sql命令（不返回数据集）
        /// <summary>
        ...
        #region ExecuteNonQuery 用现有的数据库连接执行一个sql命令（不返回数据集）
        /// <summary>
        ...
        #region ExecuteReader 用执行的数据库连接执行一个返回数据集的sql命令
        /// <summary>
        ...
        #region ExecuteDataSet 返回一个DataSet数据集
        /// <summary>
        /// 返回一个DataSet数据集
        /// </summary>
        /// <param name="connectionString">一个有效的连接字符串</param>
        ...
        #region ExecuteScalar 用指定的数据库连接字符串执行一个命令并返回一个数据集的第一列
        /// <summary>
        ...
        #region ExecuteScalar 用指定的数据库连接执行一个命令并返回一个数据集的第一列
        /// <summary>
        ...
        #region CacheParameters 将参数集合添加到缓存
        /// <summary>
        /// 将参数集合添加到缓存
        /// </summary>
        ...
        #region GetCachedParameters 找回缓存参数集合
        /// <summary>
        /// 找回缓存参数集合
        /// </summary>
