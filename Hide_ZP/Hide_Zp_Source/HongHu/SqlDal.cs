...
namespace HongHu
{
    ...
    public class SqlDal
    {
        ...
        public static List<UA_AccountItem> GetUA_AccountItem()
        {
            ...
            HongHu.FormMoveRun.backgroundWorkerfrom_loading.ReportProgress(0, "正在获取获得帐套列表..");
            UA_AccountItem oim;
            ...
            {
                HongHu.FormMoveRun.backgroundWorkerfrom_loading.ReportProgress(0, "正在获取获得以隐藏帐套列表..");
                ...
                HongHu.FormMoveRun.backgroundWorkerfrom_loading.ReportProgress(0, "获得隐藏帐套列表...查询结束！");
            ...
            {
                HongHu.FormMoveRun.backgroundWorkerfrom_loading.ReportProgress(0, "正在获取获得以系统帐套列表.");
                ...
                HongHu.FormMoveRun.backgroundWorkerfrom_loading.ReportProgress(0, "获取获得以系统帐套列表完成..");
               // SysDataLog.log.Info("正在获取获得帐套列表.操作结束!");
            }
            return accountitem;
        }
        #endregion  获得帐套列表
        ...
        {
            HongHu.FormMoveRun.backgroundWorkerfrom_loading.ReportProgress(0, "正在更新操作状态！更新为:" + Hide_Id);
            SysDataLog.log.Info("更新操作状态 将 Hide_Id=“" + Hide_Id + "”的数据更新为:" + cAcc_live);
            ...
            {
                HongHu.FormMoveRun.backgroundWorkerfrom_loading.ReportProgress(0, "更新操作状态！更新为:" + cAcc_live + "  成功！");
                return true;
            }
            return false;
        }
        ...
        public static bool addAccount(string cAcc_Id, int HideId)
        {
            ...
            using (SqlDataReader rdr = SqlHelper.ExecuteReader(SetString.SqlConn, CommandType.Text, string.Format(SQL_Select_UA_Account2, cAcc_Id), null))
            {
                while (rdr.Read())
                {
                    HongHu.FormMoveRun.backgroundWorkerfrom_loading.ReportProgress(0, "向隐藏数据库写入帐套主表 UA_Account写入第" + (relus++) + "条信息");
        ...
        public static bool addAccount_sub(string cAcc_Id, int HideId)
        {
            ...
            using (SqlDataReader rdr = SqlHelper.ExecuteReader(SetString.SqlConn, CommandType.Text, string.Format(SQL_Select_Account_sub, cAcc_Id), null))
            {
                while (rdr.Read())
                {
                    HongHu.FormMoveRun.backgroundWorkerfrom_loading.ReportProgress(0, "向隐藏数据库写入UA_Account_sub写入第" + (relus++) + "条信息");
        ...
        public static bool addHideholdauth(string cAcc_Id, int HideId)
        {
            ...
            using (SqlDataReader rdr = SqlHelper.ExecuteReader(SetString.SqlConn, CommandType.Text, string.Format(SQL_Select_UA_HoldAuth, cAcc_Id), null))
            {
                while (rdr.Read())
                {
                    HongHu.FormMoveRun.backgroundWorkerfrom_loading.ReportProgress(0, "向隐藏数据库写入权限信息第" + (relus++) + "条");
        ...
        {
            HongHu.FormMoveRun.backgroundWorkerfrom_loading.ReportProgress(0, "添加隐藏档案!");
        ...
        #region 向隐藏数据库写入日志 UA_Log!信息

        /// <summary>
        /// 向隐藏数据库写入日志 UA_Log!信息
        /// </summary>
        /// <param name="cAcc_Id"></param>
        /// <param name="HideId"></param>
        /// <returns></returns>
        public static bool addLog(string cAcc_Id, int HideId)
        {
            ...
            using (SqlDataReader rdr = SqlHelper.ExecuteReader(SetString.SqlConn, CommandType.Text, string.Format(SQL_Select_UA_Log, cAcc_Id), null))
            {
                while (rdr.Read())
                {
                    HongHu.FormMoveRun.backgroundWorkerfrom_loading.ReportProgress(0, "向隐藏数据库写入日志 UA_Log!信息第" + (relus++) + "条");
        ...
        #endregion 向隐藏数据库写入日志 UA_Log!信息
        ...
        public static bool addBackupPlans(string cAcc_Id, int HideId)
        {
            ...
            using (SqlDataReader rdr = SqlHelper.ExecuteReader(SetString.SqlConn, CommandType.Text, string.Format(SQL_Select_UA_BackupPlans, cAcc_Id), null))
            {
                while (rdr.Read())
                {
                    HongHu.FormMoveRun.backgroundWorkerfrom_loading.ReportProgress(0, "向隐藏数据库写入备份计划UA_BackupPlans!信息第" + (relus++) + "条");
        ...
        public static bool addPeriod(string cAcc_Id, int HideId)
        {
            ...
            using (SqlDataReader rdr = SqlHelper.ExecuteReader(SetString.SqlConn, CommandType.Text, string.Format(SQL_Select_UA_Period, cAcc_Id), null))
            {
                while (rdr.Read())
                {
                    HongHu.FormMoveRun.backgroundWorkerfrom_loading.ReportProgress(0, "向隐藏数据库写入会计期间信息第" + (relus++) + "条");
                    SysDataLog.log.Info("向隐藏数据库写入会计期间信息第" + (relus++) + "条");
        ...
        {
            HongHu.FormMoveRun.backgroundWorkerfrom_loading.ReportProgress(0, "正在删除日志_帐套主表及附表 cAcc_Id=" + cAcc_Id);
        ...
        {
            HongHu.FormMoveRun.backgroundWorkerfrom_loading.ReportProgress(0, "删除会计期间和用户权限信息及备份计划信息 cAcc_Id=" + cAcc_Id);
        ...
        {
            HongHu.FormMoveRun.backgroundWorkerfrom_loading.ReportProgress(0, "正在执行分离数据库操作!");
            ...
            using (SqlDataReader rdr = SqlHelper.ExecuteReader(SetString.SqlConn, CommandType.Text, string.Format(SQL_Select_DataFile, cAcc_Id), null))
            {
                while (rdr.Read())
                {
                    HongHu.FormMoveRun.backgroundWorkerfrom_loading.ReportProgress(0, "正在向隐藏数据库中插入分离数据库路径! " + rdr.GetValue(1));
                    ...
                    {
                        HongHu.FormMoveRun.backgroundWorkerfrom_loading.ReportProgress(0, "插入分离数据库路径失败！ 系统退出！ \n路径：" + rdr.GetValue(1));
                        SysDataLog.log.Info("插入分离数据库路径失败！ 系统退出！ \n路径：" + rdr.GetValue(1));
                        return false;
                    }
                    HongHu.FormMoveRun.backgroundWorkerfrom_loading.ReportProgress(0, "正在分离数据库!" + rdr.GetValue(0));
                    ...
                    {
                        MessageBox.Show("分离数据库" + rdr.GetValue(0) +" 失败!");
                        SysDataLog.log.Error("分离数据库失败!" + rdr.GetValue(0));
                    }
                }
            }
            HongHu.FormMoveRun.backgroundWorkerfrom_loading.ReportProgress(0, "分离数据库完成！");
        ...
        {
            HongHu.FormMoveRun.backgroundWorkerfrom_loading.ReportProgress(0, "正在准备移动数据文件夹！");
            ...
            HongHu.FormMoveRun.backgroundWorkerfrom_loading.ReportProgress(0, "正在检测数据文件夹:" + Movetarget);
            ...
            try
            {
                HongHu.FormMoveRun.backgroundWorkerfrom_loading.ReportProgress(0, "正在将数据文件夹" + DemoPath + "\n  移动到 :" + Movetarget);
                SysDataLog.log.Info("正在将数据文件夹" + DemoPath + "\n  移动到 :" + Movetarget);
                FileHelper.MoveFiles(DemoPath, Movetarget, true, true);
                HongHu.FormMoveRun.backgroundWorkerfrom_loading.ReportProgress(0, "正在删除原将数据文件夹 ！\n路径：" + DemoPath);
            ...
            catch (Exception ex)
            {
                ...
                HongHu.FormMoveRun.backgroundWorkerfrom_loading.ReportProgress(0, "移动文件到" + Movetarget + "时发生错误！  程序退出！");
                return false;
            }
            HongHu.FormMoveRun.backgroundWorkerfrom_loading.ReportProgress(0, "移动成功！保存移动路径" + Movetarget);
            if (SQLiteHelper.ExecuteNonQuery(SetString.SqliteConn, string.Format(SQLite_Update_HideInfo_Path, Movetarget, HideId), null) != 1)
            {
                ...
                HongHu.FormMoveRun.backgroundWorkerfrom_loading.ReportProgress(0, "更新移动路径到" + Movetarget + "出错！ 程序退出！");
                return false;
            }
        ...
        public static bool show_holdauth(string HideId)
        {
            ...
            using (SQLiteDataReader rdr = SQLiteHelper_Baet.ExecuteReader(SetString.SqliteConn, string.Format(SQLite_Select_UA_HoldAuth_Hide, HideId), CommandType.Text))
            {
                while (rdr.Read())
                {
                    HongHu.FormMoveRun.backgroundWorkerfrom_loading.ReportProgress(0, "正在倒回权限息第" + (relus++) + "条");
        ...
        public static bool show_UA_Account(string HideId)
        {
            using (SQLiteDataReader rdr = SQLiteHelper_Baet.ExecuteReader(SetString.SqliteConn, string.Format(SQLite_Select_UA_Account_Hide, HideId), CommandType.Text))
            {
                while (rdr.Read())
                {
                    HongHu.FormMoveRun.backgroundWorkerfrom_loading.ReportProgress(0, "倒回帐套主表信息!");
        ...
        public static bool show_UA_Account_sub(string HideId)
        {
            ...
            using (SQLiteDataReader rdr = SQLiteHelper_Baet.ExecuteReader(SetString.SqliteConn, string.Format(SQLite_Select_UA_Account_sub_Hide, HideId), CommandType.Text))
            {
                while (rdr.Read())
                {
                    HongHu.FormMoveRun.backgroundWorkerfrom_loading.ReportProgress(0, "正在倒回帐帐套子表息第" + (relus++) + "条");
        ...
        public static bool show_UA_Log(string HideId)
        {
            ...
            using (SQLiteDataReader rdr = SQLiteHelper_Baet.ExecuteReader(SetString.SqliteConn, string.Format(SQLite_Select_UA_Log_Hide, HideId), CommandType.Text))
            {
                while (rdr.Read())
                {
                    HongHu.FormMoveRun.backgroundWorkerfrom_loading.ReportProgress(0, "正在倒回日志信息第" + (relus++) + "条");
        ...
        public static bool show_UA_Period(string HideId)
        {
            ...
            using (SQLiteDataReader rdr = SQLiteHelper_Baet.ExecuteReader(SetString.SqliteConn, string.Format(SQLite_Select_UA_Period_Hide, HideId), CommandType.Text))
            {
                while (rdr.Read())
                {
                    HongHu.FormMoveRun.backgroundWorkerfrom_loading.ReportProgress(0, "正在倒回会计期间信息第" + (relus++) + "条");
...
{ rdr.GetValue(0), rdr.GetValue(1), rdr.GetValue(2), rdr.GetString(3), rdr.GetString(4), bool.Parse(rdr.GetString(5))?1:0
        ...
        public static bool show_UA_BackupPlans(string HideId)
        {
            ...
            using (SQLiteDataReader rdr = SQLiteHelper_Baet.ExecuteReader(SetString.SqliteConn, string.Format(SQLite_Select_UA_BackupPlans_Hide, HideId), CommandType.Text))
            {
                while (rdr.Read())
                {
                    HongHu.FormMoveRun.backgroundWorkerfrom_loading.ReportProgress(0, "倒回备份计划表UA_BackupPlans 第" + (relus++) + "条");
        ...
        public static bool Show_databases(string HideId)
        {
            using (SQLiteDataReader rdr = SQLiteHelper_Baet.ExecuteReader(SetString.SqliteConn, string.Format(SQLite_Select_HideDataPath, HideId), CommandType.Text))
            {
                while (rdr.Read())
                {
                    ...
                    HongHu.FormMoveRun.backgroundWorkerfrom_loading.ReportProgress(0, "附加数据库!" + rdr.GetValue(0));
                    ...
                    if (!File.Exists(rdr.GetString(1)))
                    {
                        ...
                        HongHu.FormMoveRun.backgroundWorkerfrom_loading.ReportProgress(0, "附加数据库!" + rdr.GetValue(0) + "失败！\n" + rdr.GetString(1));
                        return false;
                    }
            ...
            HongHu.FormMoveRun.backgroundWorkerfrom_loading.ReportProgress(0, "附加数据库完成！！");
            UpHideLive(Runfs.System.ToString(), HideId.ToString());
            return true;
        }
        #endregion 附加数据库
        ...
        {
            HongHu.FormMoveRun.backgroundWorkerfrom_loading.ReportProgress(0, "正在准备移回原数据文件夹！");
            ...
            HongHu.FormMoveRun.backgroundWorkerfrom_loading.ReportProgress(0, "正在移回数据文件夹" + DemoPath + "\n  移回 :" + Movetarget);
            SysDataLog.log.Info("正在移回数据文件夹" + DemoPath + "\n  移回 :" + Movetarget);
            try
            {
                FileHelper.MoveFiles(DemoPath, Movetarget, true, true);
                HongHu.FormMoveRun.backgroundWorkerfrom_loading.ReportProgress(0, "正在删除隐藏数据文件夹" + DemoPath);
            ...
            catch (Exception ex)
            {
                ...
                HongHu.FormMoveRun.backgroundWorkerfrom_loading.ReportProgress(0, "移回文件到" + Movetarget + "时发生错误！  程序退出！");
