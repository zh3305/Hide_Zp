...
namespace HongHu.DAL.DBUtility
{
    ...
    public abstract class SqlHelper
    {
        ...
        {
            return ("Data Source=" + DBServer + ";Initial catalog=" + DBName + ";" + "Integrated Security=False;User ID=" + DBUser) + ";Password=" + DBPass + ";";
        }
        /// <summary>
        /// 构建SSPI认证
        /// </summary>
        ...
        /// <param name="DBName">连接到的数据库</param>
        /// <returns></returns>
        public static string ConnStrFormat(string DBServer, string DBName)
        {
            return "Server=" + DBServer + ";DataBase=" + DBName + ";Integrated Security=SSPI";
        }
        /// <summary>
        /// 枚举sql 实例信息
        /// </summary>
